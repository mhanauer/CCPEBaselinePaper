...
Plot.SD<-ggplot(data=Cig.SD, aes(x=CenterRSKCIG, y=fit, group=CenterREL_IMP))+
  geom_line(size=2, aes(linetype=CenterREL_IMP))+ #Can adjust the thickness of your lines
  ...
  ggtitle("Association between Perceived Risk of Harm from Smoking Cigarettes and Actual Smoking Behavior at Different Levels of Self-Reported Religious Importance")+ #Title
...
Plot.MarIncome
  ...
  ggtitle("Association between Perceived Risk of Harm from Smoking Marijuana and Actual Smoking Behavior at Different Levels of Self-Reported Income")+
  scale_colour_discrete(name = "Income")+
  theme_bw()+ 
  theme(panel.grid.major=element_blank(),
        panel.grid.minor=element_blank())+
  theme(plot.title = element_text(size=12, vjust=2, lineheight=0.6))
...
Plot.MarIncome<-ggplot(data=MarGender.SD , aes(x=CenterRSKMJ, y=fit, group=GENDER))+
 ...
 ylab("Predicted days smoked marijuana")+
  xlab("Centered perceived susceptibility of smoking marijuana")+
  ggtitle("Association between Perceived Risk of Harm from Smoking Marijuana and Actual Smoking Behavior at Different Levels of Self-Reported Gender")+

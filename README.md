...
#
```{r}
CCPEBaselineMeanCenter = data.frame(CCPEBaseline$RSKCIG, CCPEBaseline$RSKMJ, CCPEBaseline$RSKALC, CCPEBaseline$INCOME, CCPEBaseline$AGE, CCPEBaseline$REL_IMP)
CCPEBaselineMeanCenter = scale(CCPEBaselineMeanCenter, scale = FALSE)
CCPEBaseline = data.frame(CCPEBaselineMeanCenter, CCPEBaseline$CIG30D, CCPEBaseline$MJ30D, CCPEBaseline$BINGE530D, CCPEBaseline$R_WHITE_N, CCPEBaseline$SEX_PR, CCPEBaseline$GENDER)
CCPEBaseline
colnames(CCPEBaseline) = c("RSKCIG", "RSKMJ", "RSKALC", "INCOME", "AGE", "REL_IMP", "CIG30D", "MJ30D","BINGE530D", "R_WHITE_N", "SEX_PR", "GENDER")
...
marPos = glm(MJ30D ~  R_WHITE_N + AGE + REL_IMP + INCOME + SEX_PR+ GENDER, family = "poisson", data = CCPEBaseline)
summary(marPos)
...
mar1 = glm.nb(MJ30D ~ RSKMJ + R_WHITE_N + RSKMJ*REL_IMP + AGE  + REL_IMP + INCOME + SEX_PR+ GENDER , data = CCPEBaseline1)
summary(mar1)

mar2 = glm.nb(MJ30D ~ RSKMJ + R_WHITE_N + RSKMJ*REL_IMP + AGE  + REL_IMP + INCOME + SEX_PR+ GENDER , data = CCPEBaseline2)
summary(mar2)

mar3 = glm.nb(MJ30D ~ RSKMJ + R_WHITE_N + RSKMJ*REL_IMP + AGE  + REL_IMP + INCOME + SEX_PR+ GENDER , data = CCPEBaseline3)
summary(mar3)

mar4 = glm.nb(MJ30D ~ RSKMJ + R_WHITE_N + RSKMJ*REL_IMP + AGE  + REL_IMP + INCOME + SEX_PR+ GENDER , data = CCPEBaseline4)
summary(mar4)

mar5 = glm.nb(MJ30D ~ RSKMJ + R_WHITE_N + RSKMJ*REL_IMP + AGE  + REL_IMP + INCOME + SEX_PR+ GENDER , data = CCPEBaseline5)
summary(mar5)
...
```{r}
#alcohol = glm.nb(MJ30D ~ RSKMJ + R_WHITE_N + RSKMJ*REL_IMP + AGE  + REL_IMP + INCOME + SEX_PR+ GENDER , data = CCPEBaseline)
summary(alcohol)

alcohol1 = glm.nb(MJ30D ~ RSKMJ + R_WHITE_N + RSKMJ*REL_IMP + AGE  + REL_IMP + INCOME + SEX_PR+ GENDER , data = CCPEBaseline1)
summary(alcohol1)

alcohol2 = glm.nb(MJ30D ~ RSKMJ + R_WHITE_N + RSKMJ*REL_IMP + AGE  + REL_IMP + INCOME + SEX_PR+ GENDER , data = CCPEBaseline2)
summary(alcohol2)

alcohol3 = glm.nb(MJ30D ~ RSKMJ + R_WHITE_N + RSKMJ*REL_IMP + AGE  + REL_IMP + INCOME + SEX_PR+ GENDER , data = CCPEBaseline3)
summary(alcohol3)

alcohol4 = glm.nb(MJ30D ~ RSKMJ + R_WHITE_N + RSKMJ*REL_IMP + AGE  + REL_IMP + INCOME + SEX_PR+ GENDER , data = CCPEBaseline4)
summary(alcohol4)

alcohol5 = glm.nb(MJ30D ~ RSKMJ + R_WHITE_N + RSKMJ*REL_IMP + AGE  + REL_IMP + INCOME + SEX_PR+ GENDER , data = CCPEBaseline5)
summary(alcohol5)

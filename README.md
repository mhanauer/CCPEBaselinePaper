...
```{r}
attach(CCPEBaseline)
R_WHITE_Marj = compmeans(MJ30D, R_WHITE_N)
REL_IMPMarji = compmeans(MJ30D, REL_IMP)
INCOMEMarj = compmeans(MJ30D, INCOME)
SEX_PRMarj = compmeans(MJ30D, SEX_PR)
genderMarj = compmeans(MJ30D, GENDER)

## Change age to split in the mean
ageMean = mean(AGE)
ageMean
AGECross = ifelse(AGE > ageMean, 1, 0)
ageMarj = compmeans(MJ30D, AGECross)
ageMarj

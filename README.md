...
mar = glm.nb(MJ30D ~ R_WHITE_N + CenterRSKMJ*INCOME + CenterRSKMJ*GENDER  +  AGE  + REL_IMP + INCOME + SEX_PR+ GENDER , data = CCPEBaselineTest)
summary(mar)
test = jn(mar, dv = "MJ30D", iv = "CenterRSKMJ", mod = "GENDER")
test
plot.jn(test)
test = pickapoint(mar, dv = "MJ30D", iv = "CenterRSKMJ", mod = "INCOME")
plot(test)

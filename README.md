...
Then we are using the sim_slopes, which
```{r}
library(jtools)
CCPEBaseline = data.frame(na.omit(CCPEBaseline))
...
interact_plot(mar, pred= "CenterRSKMJ", modx = "GENDER")
interact_plot(mar,  pred= "CenterRSKMJ", modx = "INCOME")
interact_plot(cigTest, pred = "CenterRSKCIG", modx = "CenterREL_IMP")

marGender =  sim_slopes(mar, pred= "CenterRSKMJ", modx = "GENDER", johnson_neyman = TRUE, control.fdr = TRUE, robust = TRUE)
marGender

marIncome = sim_slopes(mar, pred= "INCOME", modx = "CenterRSKMJ", johnson_neyman = TRUE, control.fdr = TRUE, robust = TRUE)
marIncome

cigRel = sim_slopes(cigTest, pred = "CenterRSKCIG", modx = "CenterREL_IMP", johnson_neyman = TRUE, control.fdr = TRUE, robust = TRUE)
cigRel
cigRel

johnson_neyman(mar, pred= "GENDER", modx = "CenterRSKMJ")
